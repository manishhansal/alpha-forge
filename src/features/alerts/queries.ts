...
export async function createAlert(userId: string, input: AlertCreateInput): Promise<AlertRow> {
  ...
  return prisma.alert.create({
    data: {
      ...
      channels: input.channels as import("@prisma/client").AlertChannelEnum[],
...
export async function updateAlert(
  ...
  const updated = await prisma.alert.updateMany({
    ...
    data: {
      ...
      ...(input.channels !== undefined ? { channels: input.channels as import("@prisma/client").AlertChannelEnum[] } : {}),
