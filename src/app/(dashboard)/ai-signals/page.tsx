  ...
  return (
    <PageTransition>
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        <PageHeader
          title="AI Signals · Crypto"
          subtitle="The AI reads BTC / ETH / SOL across price action, derivatives positioning, liquidation flow, sentiment, and macro session quality — then publishes a confidence-scored trade plan with a tiered take-profit ladder, ATR-sized stop, position sizing recommendation, and the exact entry / exit window."
        />
