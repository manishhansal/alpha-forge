...
import { AiRadarSection } from "@/components/india/ai-signals/ai-radar-section";
import { signalToRadarRow } from "@/lib/signal-to-radar-row";
  ...
  return (
    <>
      <AiSignalsBoard
        ...
        currency="inr"
      />
      <AiRadarSection rows={radarRows} loading={false} />
    </>
  );
}
  ...
  return (
    <PageTransition>
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        <PageHeader
          title="AI Signals · NSE F&O"
          subtitle="Multi-confluence AI trading signals for NIFTY, BANKNIFTY, FINNIFTY and high-liquidity F&O leaders"
        />
